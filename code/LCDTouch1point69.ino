...
uint16_t channel_color[] = {
  RED, ORANGE, YELLOW, GREEN, BLUE, CYAN, WHITE,
  YELLOW, ORANGE, RED, MAGENTA, BLUE, CYAN, WHITE,
};
...
void loop() {
  ...
  gfx->print(n);
  gfx->print(" APs Found - LOW Noise Channels:");
  ...
  gfx->drawFastHLine(0, graph_baseline, gfx->width(), ORANGE);
